...
Router.get('/files/fetch',FetchUser,filesControllers().Fetch) //Fetching the contents by the users
Router.post('/files/add',FetchUser,Upload.single('myfile'),filesControllers().Add) //Adding the contents by the users
Router.patch('/files/update/:_id',FetchUser,Upload.single('myfile'),filesControllers().Update) //Updating the content by the users, using '/api/courses/update/:_id'
Router.delete('/files/delete/:_id',FetchUser,filesControllers().Delete) // Deleting the courses by the mentors, using DELETE '/api/courses/delete/:_id'
